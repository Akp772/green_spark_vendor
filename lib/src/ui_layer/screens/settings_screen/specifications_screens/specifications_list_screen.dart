...
class SpecificationListScreen extends StatefulWidget {
  const SpecificationListScreen({Key? key}) : super(key: key);

  @override
  State<SpecificationListScreen> createState() => _SpecificationListScreenState();
}
...
class _SpecificationListScreenState extends State<SpecificationListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const AppBarWidget(title: "Specification",),
      body: _mainWidget(),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
              flex: 3,
              child: _commonBoldText("Product Name",fontSize: 14)),
          AppStyles.sbWidth10,
          Expanded(
              flex: 3,
              child: _commonBoldText("Message",fontSize: 14)),
          AppStyles.sbWidth10,
          Expanded(
              flex: 2,
